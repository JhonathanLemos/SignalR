        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Server_AspNetUsers_AdminId",
                        column: x => x.AdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Solicitation", x => new { x.UserId, x.SecondUserId });
                    table.ForeignKey(
                        name: "FK_Solicitation_AspNetUsers_SecondUserId",
                        column: x => x.SecondUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MessageChannel_AspNetUsers_SenderId",
                        column: x => x.SenderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MessageChannel_Channel_ChannelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageChannel_ChannelId",
                table: "MessageChannel",
                column: "ChannelId");

            migrationBuilder.CreateIndex(
                name: "IX_MessageChannel_SenderId",
                table: "MessageChannel",
                column: "SenderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Solicitation_SecondUserId",
                table: "Solicitation",
                column: "SecondUserId");
